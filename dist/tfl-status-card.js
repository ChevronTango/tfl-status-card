...
/* harmony import */ var _style_editor_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style-editor.js */ "./src/style-editor.js");
...
class HelloWorldCardEditor extends lit_element__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  ...
  static get styles() {
    return _style_editor_js__WEBPACK_IMPORTED_MODULE_1__["default"];
  }
  ...
  render() {
    ...
    const options = this.entityOptions.map(entity => (0,lit_element__WEBPACK_IMPORTED_MODULE_0__.html)`<mwc-list-item value="${entity}" ?selected=${entity === this._config.entity}>${entity}</mwc-list-item>`);
...
/******/ })()
;
//# sourceMappingURL=tfl-status-card.js.map